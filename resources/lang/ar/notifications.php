...
return [
    ...
    'added_to_group' => ':user ضافك لـ :group',
    ...
    'view_comment' => 'شوف التعليق',
    'view_profile' => 'شوف البروفايل',
    'view_message' => 'شوف الرسالة',
    'view_group' => 'شوف المجموعة',
    'view_story' => 'شوف القصة',
    'accept_invite' => 'اقبل الدعوة',
    'decline_invite' => 'ارفض الدعوة',
    ...
    'notifications_cleared' => 'كل الإشعارات اتمسحت',
    'notification_deleted' => 'الإشعار اتحذف',
    ...
    'push_notifications' => 'إشعارات المتصفح',
    'stay_updated' => 'خليك على اطلاع لحظة بلحظة',
    'never_miss_moment' => 'متفوتكش أي لحظة',
    'enable_push_desc_detailed' => 'احصل على إشعارات فورية للإعجابات والتعليقات والرسائل والمزيد. فعل الإشعارات عشان تفضل متصل!',
    'safe_secure' => 'آمن ومضمون - تقدر تعطله في أي وقت',
    'notification_preferences' => 'إعدادات الإشعارات',
    'choose_notifications' => 'اختار اللي عايز تحصل على إشعارات حوله',
    'likes' => 'الإعجابات',
    ...
    'messages' => 'الرسائل',
    'when_new_message' => 'لما توصلك رسالة جديدة',
    'mentions' => 'المنشن',
